...
@property (nonatomic, readonly, strong) NSMutableSet *indexPaths;
@property (nonatomic, readonly, strong) NSMutableDictionary *reusableViewsDictionary;

@property (nonatomic, assign) NSInteger numberOfColumms;

@property (nonatomic, readonly,strong) NSMutableArray *indexPathsByColumn;
@property (nonatomic, readonly,strong) NSMutableArray *cellTopByColumn;
@property (nonatomic, readonly) int *topByColumn;
@property (nonatomic, readonly) int *bottomByColumn;
@property (nonatomic, readonly,strong) NSMutableArray *indexPathToViewByColumn;
...
- (int *)topByColumn {
    if (!_topByColumn) {
        _topByColumn = (int *)malloc(sizeof(int) * _numberOfColumms);
    }
    return _topByColumn;
}
...
- (int *)bottomByColumn {
    if (!_bottomByColumn) {
        _bottomByColumn = (int *)malloc(sizeof(int) * _numberOfColumms);
    }
